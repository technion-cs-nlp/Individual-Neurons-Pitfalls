...
if __name__ == "__main__":
    ...
    with open(Path(res_file_dir,res_file_name),'w+') as f:
        ...
        train_data_handler = data_model(train_path, data_name=data_name, layer=layer, control=control,
        ...
        test_data_handler = data_model(test_path, data_name=data_name, layer=layer, control=control,
                                       small_dataset=small_dataset, language=language, attribute=attribute)
